...
/**
 * Clase encargada de crear la consulta SQL para recoger informaciÛn sobre profesores
 * 
 */
public class RepositorioProfesores {
	...
	/**
	 * Recorre el resultado de la consulta a la BD y crea los objetos Profesor
	 * 
	 * Devuelve una lista con todos los profesores resultantes de la consulta.
	 * 
	 * @param rs
	 * @return
	 */
	...
	/**
	 * 
	 * Crea la consulta SQL para recoger informaciÛn sobre los profesores.
	 * 
	 * Para cada uno de los posibles campos, aÒade la parte de la consulta necesaria
	 * 
	 * @param name
	 * @param apellido1
	 * @param apellido2
	...
	/**
	 * 
	 * Crea la consulta SQL para recoger nombre y apellidos de TODOS
	 * los profesores de la BD
	 * 
	 * @return
	 */
