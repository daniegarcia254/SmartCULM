...
/**
 * Clase encargada de crear la consulta SQL para recoger información sobre horarios de los cursos
 * 
 */
public class RepositorioCurso {
	...
	/**
	 * Recorre el resultado de la consulta a la BD y crea los objetos Curso
	 * 
	 * Devuelve una lista con todos los cursos resultantes de la consulta.
	 * 
	 * @param rs
	 * @return
	 */
	...
	/**
	 * 
	 * Crea la consulta SQL para recoger información sobre los horarios.
	 * 
	 * Para cada uno de los posibles campos, añade la parte de la consulta necesaria
	 * 
	 * @param name
	 * @param apellido1
	 * @param apellido2
