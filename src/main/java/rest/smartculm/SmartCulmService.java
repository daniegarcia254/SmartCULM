...
import bd.minos.RepositorioCurso;
import bd.minos.RepositorioProfesores;
import rest.smartculm.dominio.Curso;
import rest.smartculm.dominio.Examen;
import rest.smartculm.dominio.Noticia;
import rest.smartculm.dominio.Incidencia;
import rest.smartculm.dominio.Profesor;
import rest.smartculm.scrapping.Scrapper;

/**
 * 
 * Servicio RESTful del SmartCULM
 *
 */
...
public class SmartCulmService {
	...
	/**
	 * Devuelve el listado de noticias que aparecen en la página web del Centro 
	 * Universitario de Lenguas Modernas.
	 * 
	 ...
	 * que aparecen en la página web del Centro Universitario de Lenguas Modernas.
	 * 
	...
	/**
	 * Devuelve el listado con los links a las convocatorias de Septiembre por curso y horario
	 * que aparecen en la página web del Centro Universitario de Lenguas Modernas.
	 * 
	 * @return lista de convocatorias de Septiembre
	 */
	...
	/**
	 * Devuelve el listado de profesores que cumplen los campos de búsqueda
	 * introducidos por el usuario en la aplicación cliente
	 * 
	...
	/**
	 * Devuelve el listado de horarios que cumplen los campos de búsqueda
	 * introducidos por el usuario en la aplicación cliente
	 * 
